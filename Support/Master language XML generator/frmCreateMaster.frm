...
Private Sub cmdProcess_Click()
    ...
    outputText = outputText & vbTab & "<langversion>1.0.0</langversion>" & vbCrLf
...
'Given a line number and the original file contents, search for arbitrary text between two quotation marks
Private Function findCaptionInQuotes(ByRef srcLines() As String, ByRef lineNumber As Long) As String
