...
Begin VB.Form FormPreferences 
   ...
   Begin PhotoDemon.jcbutton cmdCategory 
      ...
      Mode            =   2
      HandPointer     =   -1  'True
      PictureNormal   =   "VBP_FormPreferences.frx":41D2
      PictureAlign    =   6
      PictureEffectOnDown=   0
      DisabledPictureMode=   1
      CaptionEffects  =   0
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.PictureBox picAlphaTwo 
         ...
         Height          =   360
         Left            =   6240
         MouseIcon       =   "VBP_FormPreferences.frx":5376
         MousePointer    =   99  'Custom
         ScaleHeight     =   22
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   37
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox ChkLogMessages 
         ...
         Left            =   240
         TabIndex        =   27
         ToolTipText     =   $"VBP_FormPreferences.frx":54C8
         Top             =   600
         Width           =   6975
      End
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox chkFancyFonts 
         Appearance      =   0  'Flat
         Caption         =   "use modern typefaces (only available on Vista, Windows 7, and Windows 8)"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.PictureBox picCanvasColor 
         ...
         Height          =   360
         Left            =   5520
         MouseIcon       =   "VBP_FormPreferences.frx":55BA
         MousePointer    =   99  'Custom
         ScaleHeight     =   22
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   37
         ...
         Width           =   585
      End
      Begin VB.Label lblFancyFonts 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "when rendering interface text:"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox ChkPromptPluginDownload 
         ...
         Left            =   240
         TabIndex        =   21
         ToolTipText     =   $"VBP_FormPreferences.frx":570C
         Top             =   1080
         Width           =   6735
      End
