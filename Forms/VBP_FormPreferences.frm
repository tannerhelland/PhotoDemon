...
Begin VB.Form FormPreferences 
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox chkLogMessages 
         ...
         Left            =   240
         TabIndex        =   21
         ToolTipText     =   $"VBP_FormPreferences.frx":8374
         Top             =   480
         Width           =   6975
      End
      ...
      Begin VB.Label lblTempPathWarning 
         Caption         =   $"VBP_FormPreferences.frx":8466
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox chkPromptPluginDownload 
         ...
         Left            =   240
         TabIndex        =   17
         ToolTipText     =   $"VBP_FormPreferences.frx":8515
         Top             =   1080
         Width           =   6735
      End
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.ComboBox cmbMRUCaption 
         ...
         TabIndex        =   50
         ToolTipText     =   $"VBP_FormPreferences.frx":85B1
         Top             =   2520
         Width           =   4575
      End
      ...
      Begin VB.ComboBox cmbCanvas 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   10
         ToolTipText     =   $"VBP_FormPreferences.frx":865A
         Top             =   480
         Width           =   4815
      End
      Begin VB.PictureBox picCanvasColor 
         ...
         Height          =   360
         Left            =   7680
         MouseIcon       =   "VBP_FormPreferences.frx":86F3
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox chkValidateAlpha 
         ...
         Left            =   360
         TabIndex        =   46
         ToolTipText     =   $"VBP_FormPreferences.frx":8845
         Top             =   3240
         Width           =   7695
      End
      Begin VB.ComboBox cmbAlphaCheckSize 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   31
         ToolTipText     =   $"VBP_FormPreferences.frx":8917
         Top             =   2010
         Width           =   5055
      End
      Begin VB.ComboBox cmbAlphaCheck 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   28
         ToolTipText     =   $"VBP_FormPreferences.frx":89AA
         Top             =   900
         Width           =   5055
      End
      Begin VB.PictureBox picAlphaOne 
         ...
         Height          =   360
         Left            =   5520
         MouseIcon       =   "VBP_FormPreferences.frx":8A3F
         MousePointer    =   99  'Custom
         ScaleHeight     =   22
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   37
      ...
      Begin VB.PictureBox picAlphaTwo 
         ...
         Height          =   360
         Left            =   6240
         MouseIcon       =   "VBP_FormPreferences.frx":8B91
         MousePointer    =   99  'Custom
         ScaleHeight     =   22
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   37
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.ComboBox cmbPPMFormat 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   79
         ToolTipText     =   $"VBP_FormPreferences.frx":8CE3
         Top             =   3660
         Width           =   5055
      End
      Begin VB.ComboBox cmbDefaultSaveFormat 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   74
         ToolTipText     =   $"VBP_FormPreferences.frx":8D86
         Top             =   2070
         Width           =   7215
      End
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox chkInitialColorDepth 
         ...
         Left            =   720
         TabIndex        =   84
         ToolTipText     =   $"VBP_FormPreferences.frx":8E7B
         Top             =   825
         Width           =   7455
      End
      Begin VB.ComboBox cmbMultiImage 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   57
         ToolTipText     =   $"VBP_FormPreferences.frx":8F60
         Top             =   4125
         Width           =   4095
      End
      Begin VB.CheckBox chkToneMapping 
         ...
         Left            =   720
         TabIndex        =   55
         ToolTipText     =   $"VBP_FormPreferences.frx":9008
         Top             =   3150
         Width           =   7455
      End
      Begin VB.ComboBox cmbLargeImages 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   44
         ToolTipText     =   $"VBP_FormPreferences.frx":90D2
         Top             =   1695
         Width           =   4815
      End
      Begin VB.Label lblInterfaceTitle 
      ...
      Begin VB.Label lblFreeImageWarning 
         Caption         =   $"VBP_FormPreferences.frx":918C
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
