...
Begin VB.Form FormPreferences 
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.PictureBox picFileContainer 
         ...
         Begin VB.CheckBox chkPNGBackground 
            Appearance      =   0  'Flat
            Caption         =   " preserve original background color, if available"
            BeginProperty Font 
               Name            =   "Tahoma"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.PictureBox picFileContainer 
         ...
         Begin VB.CheckBox chkBMPRLE 
            ...
            Left            =   600
            TabIndex        =   99
            ToolTipText     =   $"VBP_FormPreferences.frx":8495
            Top             =   600
            Width           =   7215
         End
         Begin VB.Label lblInterfaceTitle 
      ...
      Begin VB.PictureBox picFileContainer 
         ...
         Begin VB.CheckBox chkTIFFCMYK 
            ...
            Left            =   600
            TabIndex        =   96
            ToolTipText     =   $"VBP_FormPreferences.frx":8541
            Top             =   1560
            Visible         =   0   'False
            Width           =   7215
         End
         Begin VB.ComboBox cmbTIFFCompression 
            ...
            Style           =   2  'Dropdown List
            TabIndex        =   90
            ToolTipText     =   "TIFFs support a variety of compression techniques.  Some of these techniques are limited to specific color depths."
            Top             =   960
            Width           =   7095
         End
         Begin VB.Label lblInterfaceTitle 
      ...
      Begin VB.PictureBox picFileContainer 
         ...
         Begin VB.ComboBox cmbPPMFormat 
            ...
            Style           =   2  'Dropdown List
            TabIndex        =   87
            ToolTipText     =   $"VBP_FormPreferences.frx":85E3
            Top             =   600
            Width           =   4935
         End
         Begin VB.Label lblInterfaceTitle 
      ...
      Begin VB.Label lblFileFreeImageWarning 
         BackStyle       =   0  'Transparent
         Caption         =   $"VBP_FormPreferences.frx":8686
         ForeColor       =   &H000000FF&
         Height          =   495
         Left            =   600
         TabIndex        =   97
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.ComboBox cmbExportColorDepth 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   80
         ToolTipText     =   $"VBP_FormPreferences.frx":8737
         Top             =   1680
         Width           =   4995
      End
      Begin VB.ComboBox cmbSaveBehavior 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   77
         ToolTipText     =   $"VBP_FormPreferences.frx":87FA
         Top             =   3840
         Width           =   5415
      End
      Begin VB.ComboBox cmbDefaultSaveFormat 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   69
         ToolTipText     =   $"VBP_FormPreferences.frx":88C7
         Top             =   2910
         Width           =   7335
      End
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox chkInitialColorDepth 
         ...
         Left            =   720
         TabIndex        =   76
         ToolTipText     =   $"VBP_FormPreferences.frx":89BC
         Top             =   825
         Width           =   7455
      End
      Begin VB.ComboBox cmbMultiImage 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   57
         ToolTipText     =   $"VBP_FormPreferences.frx":8AA1
         Top             =   4125
         Width           =   4095
      End
      Begin VB.CheckBox chkToneMapping 
         ...
         Left            =   720
         TabIndex        =   55
         ToolTipText     =   $"VBP_FormPreferences.frx":8B49
         Top             =   3150
         Width           =   7455
      End
      Begin VB.ComboBox cmbLargeImages 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   44
         ToolTipText     =   $"VBP_FormPreferences.frx":8C13
         Top             =   1695
         Width           =   4815
      End
      Begin VB.Label lblInterfaceTitle 
      ...
      Begin VB.Label lblFreeImageWarning 
         Caption         =   $"VBP_FormPreferences.frx":8CCD
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox chkSelectionClearCrop 
         ...
         Left            =   360
         TabIndex        =   61
         ToolTipText     =   $"VBP_FormPreferences.frx":8DE2
         Top             =   480
         Width           =   7455
      End
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox chkLogMessages 
         ...
         Left            =   240
         TabIndex        =   21
         ToolTipText     =   $"VBP_FormPreferences.frx":8EC6
         Top             =   480
         Width           =   6975
      End
      ...
      Begin VB.Label lblTempPathWarning 
         Caption         =   $"VBP_FormPreferences.frx":8FB8
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox chkPromptPluginDownload 
         ...
         Left            =   240
         TabIndex        =   17
         ToolTipText     =   $"VBP_FormPreferences.frx":9067
         Top             =   1080
         Width           =   6735
      End
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.ComboBox cmbMRUCaption 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   50
         ToolTipText     =   $"VBP_FormPreferences.frx":9103
         Top             =   2520
         Width           =   4575
      End
      ...
      Begin VB.ComboBox cmbCanvas 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   10
         ToolTipText     =   $"VBP_FormPreferences.frx":91AC
         Top             =   480
         Width           =   4815
      End
      Begin VB.PictureBox picCanvasColor 
         ...
         Height          =   360
         Left            =   7680
         MouseIcon       =   "VBP_FormPreferences.frx":9245
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox chkValidateAlpha 
         ...
         Left            =   360
         TabIndex        =   46
         ToolTipText     =   $"VBP_FormPreferences.frx":9397
         Top             =   3240
         Width           =   7695
      End
      Begin VB.ComboBox cmbAlphaCheckSize 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   31
         ToolTipText     =   $"VBP_FormPreferences.frx":9469
         Top             =   2010
         Width           =   5055
      End
      Begin VB.ComboBox cmbAlphaCheck 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   28
         ToolTipText     =   $"VBP_FormPreferences.frx":94FC
         Top             =   900
         Width           =   5055
      End
      Begin VB.PictureBox picAlphaOne 
         ...
         Height          =   360
         Left            =   5520
         MouseIcon       =   "VBP_FormPreferences.frx":9591
         MousePointer    =   99  'Custom
         ScaleHeight     =   22
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   37
      ...
      Begin VB.PictureBox picAlphaTwo 
         ...
         Height          =   360
         Left            =   6240
         MouseIcon       =   "VBP_FormPreferences.frx":96E3
         MousePointer    =   99  'Custom
         ScaleHeight     =   22
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   37
