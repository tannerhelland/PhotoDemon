...
Begin VB.Form FormPreferences 
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.Label lblTempPathWarning 
         Caption         =   $"VBP_FormPreferences.frx":62DE
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox ChkPromptPluginDownload 
         ...
         Left            =   240
         TabIndex        =   18
         ToolTipText     =   $"VBP_FormPreferences.frx":638D
         Top             =   1080
         Width           =   6735
      End
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.ComboBox cmbMultiImage 
         ...
         TabIndex        =   62
         ToolTipText     =   $"VBP_FormPreferences.frx":6429
         Top             =   2820
         Width           =   4095
      End
      Begin VB.CheckBox chkToneMapping 
         ...
         Left            =   720
         TabIndex        =   60
         ToolTipText     =   $"VBP_FormPreferences.frx":64D1
         Top             =   885
         Width           =   7455
      End
      Begin VB.ComboBox cmbLargeImages 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   48
         ToolTipText     =   $"VBP_FormPreferences.frx":659B
         Top             =   1830
         Width           =   4815
      End
      ...
      Begin VB.Label lblFreeImageWarning 
         Caption         =   $"VBP_FormPreferences.frx":6655
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.ComboBox cmbMRUCaption 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   55
         ToolTipText     =   $"VBP_FormPreferences.frx":676A
         Top             =   2520
         Width           =   4575
      End
      ...
      Begin VB.ComboBox cmbCanvas 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   10
         ToolTipText     =   $"VBP_FormPreferences.frx":6813
         Top             =   480
         Width           =   4815
      End
      Begin VB.PictureBox picCanvasColor 
         ...
         Height          =   360
         Left            =   7680
         MouseIcon       =   "VBP_FormPreferences.frx":68AC
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox chkValidateAlpha 
         ...
         Left            =   360
         TabIndex        =   51
         ToolTipText     =   $"VBP_FormPreferences.frx":69FE
         Top             =   3240
         Width           =   7695
      End
      Begin VB.ComboBox cmbAlphaCheckSize 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   33
         ToolTipText     =   $"VBP_FormPreferences.frx":6AD0
         Top             =   2010
         Width           =   5055
      End
      Begin VB.ComboBox cmbAlphaCheck 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   30
         ToolTipText     =   $"VBP_FormPreferences.frx":6B63
         Top             =   900
         Width           =   5055
      End
      Begin VB.PictureBox picAlphaOne 
         ...
         Height          =   360
         Left            =   5520
         MouseIcon       =   "VBP_FormPreferences.frx":6BF8
         MousePointer    =   99  'Custom
         ScaleHeight     =   22
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   37
      ...
      Begin VB.PictureBox picAlphaTwo 
         ...
         Height          =   360
         Left            =   6240
         MouseIcon       =   "VBP_FormPreferences.frx":6D4A
         MousePointer    =   99  'Custom
         ScaleHeight     =   22
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   37
...
Private Sub LoadAllPreferences()
    ...
    lblMemoryUsage.Caption = "Current PhotoDemon memory usage: " & Format(CStr(GetPhotoDemonMemoryUsage()), "###,###,###,###") & " K" & vbCrLf & "Max PhotoDemon memory usage this session: " & Format(CStr(GetPhotoDemonMemoryUsage(True)), "###,###,###,###") & " K"
    If Not IsProgramCompiled Then lblMemoryUsage = lblMemoryUsage.Caption & vbCrLf & "Note: memory readings are not very accurate due while inside the IDE.  Please compile."
...
Private Sub Form_Load()
    ...
    'Updates
    cmdCategory(4).ToolTip = "Update preferences control how frequently PhotoDemon checks for" & vbCrLf & "updated versions, and how it handles the download of missing plugins."
    'Advanced
    cmdCategory(5).ToolTip = "Advanced preferences can be safely ignored by regular users." & vbCrLf & "Testers and developers may, however, find these settings useful."
