...
Begin VB.Form FormPreferences 
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox ChkLogMessages 
         ...
         Left            =   240
         TabIndex        =   21
         ToolTipText     =   $"VBP_FormPreferences.frx":8382
         Top             =   480
         Width           =   6975
      End
      ...
      Begin VB.Label lblTempPathWarning 
         Caption         =   $"VBP_FormPreferences.frx":8474
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox ChkPromptPluginDownload 
         ...
         Left            =   240
         TabIndex        =   17
         ToolTipText     =   $"VBP_FormPreferences.frx":8523
         Top             =   1080
         Width           =   6735
      End
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.ComboBox cmbMRUCaption 
         ...
         TabIndex        =   50
         ToolTipText     =   $"VBP_FormPreferences.frx":85BF
         Top             =   2520
         Width           =   4575
      End
      ...
      Begin VB.ComboBox cmbCanvas 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   10
         ToolTipText     =   $"VBP_FormPreferences.frx":8668
         Top             =   480
         Width           =   4815
      End
      Begin VB.PictureBox picCanvasColor 
         ...
         Height          =   360
         Left            =   7680
         MouseIcon       =   "VBP_FormPreferences.frx":8701
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.CheckBox chkValidateAlpha 
         ...
         Left            =   360
         TabIndex        =   46
         ToolTipText     =   $"VBP_FormPreferences.frx":8853
         Top             =   3240
         Width           =   7695
      End
      Begin VB.ComboBox cmbAlphaCheckSize 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   31
         ToolTipText     =   $"VBP_FormPreferences.frx":8925
         Top             =   2010
         Width           =   5055
      End
      Begin VB.ComboBox cmbAlphaCheck 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   28
         ToolTipText     =   $"VBP_FormPreferences.frx":89B8
         Top             =   900
         Width           =   5055
      End
      Begin VB.PictureBox picAlphaOne 
         ...
         Height          =   360
         Left            =   5520
         MouseIcon       =   "VBP_FormPreferences.frx":8A4D
         MousePointer    =   99  'Custom
         ScaleHeight     =   22
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   37
      ...
      Begin VB.PictureBox picAlphaTwo 
         ...
         Height          =   360
         Left            =   6240
         MouseIcon       =   "VBP_FormPreferences.frx":8B9F
         MousePointer    =   99  'Custom
         ScaleHeight     =   22
         ScaleMode       =   3  'Pixel
         ScaleWidth      =   37
   ...
   Begin VB.PictureBox picContainer 
      ...
      Begin VB.ComboBox cmbMultiImage 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   57
         ToolTipText     =   $"VBP_FormPreferences.frx":8CF1
         Top             =   2340
         Width           =   4095
      End
      Begin VB.CheckBox chkToneMapping 
         ...
         Left            =   360
         TabIndex        =   55
         ToolTipText     =   $"VBP_FormPreferences.frx":8D99
         Top             =   405
         Width           =   7455
      End
      Begin VB.ComboBox cmbLargeImages 
         ...
         Style           =   2  'Dropdown List
         TabIndex        =   44
         ToolTipText     =   $"VBP_FormPreferences.frx":8E63
         Top             =   1350
         Width           =   4815
      End
      Begin VB.Label lblFreeImageWarning 
         Caption         =   $"VBP_FormPreferences.frx":8F1D
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
            Charset         =   0
