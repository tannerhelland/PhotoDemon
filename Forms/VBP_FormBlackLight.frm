...
Begin VB.Form FormBlackLight 
   ...
   Begin VB.HScrollBar hsIntensity 
      ...
      Max             =   10
      Min             =   1
      MouseIcon       =   "VBP_FormBlackLight.frx":0000
   ...
   Begin VB.CommandButton CmdCancel 
      ...
      Height          =   375
      Left            =   3720
      MouseIcon       =   "VBP_FormBlackLight.frx":0152
      MousePointer    =   99  'Custom
      TabIndex        =   3
      Top             =   3840
      Width           =   1125
   ...
   Begin VB.CommandButton CmdOK 
      ...
      Height          =   375
      Left            =   2520
      MouseIcon       =   "VBP_FormBlackLight.frx":02A4
      MousePointer    =   99  'Custom
      TabIndex        =   2
      Top             =   3840
      Width           =   1125
...
'Last updated: 14/June/07
'Last update: textbox and loads of good error checking.  Bravo for me.
'
'I found this effect on accident, and it has turned out to be one of
'my favorite effects.  On some images it looks amazing!  Lucky!!
'
'***************************************************************************
