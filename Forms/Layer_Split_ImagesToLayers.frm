...
'
'To make editing animated images easier, PhotoDemon 7.2 gained the ability to split multi-layer images into
' a multi-image session, then merge those images back into a single multi-layer image.
'
