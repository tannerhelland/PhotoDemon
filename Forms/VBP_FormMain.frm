...
Begin VB.MDIForm FormMain 
   ...
   Begin VB.PictureBox picRightPane 
      ...
      Begin VB.PictureBox picTools 
         ...
         Begin VB.ComboBox cmbSelRender 
            ...
            TabIndex        =   17
            TabStop         =   0   'False
            ToolTipText     =   $"VBP_FormMain.frx":0040
            Top             =   540
            Width           =   2685
         End
   ...
   Begin VB.PictureBox picLeftPane 
      ...
      Begin VB.ComboBox CmbZoom 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "VBP_FormMain.frx":83B0
         Left            =   60
         List            =   "VBP_FormMain.frx":83B2
         Style           =   2  'Dropdown List
         TabIndex        =   5
      ...
      Begin PhotoDemon.jcbutton cmdOpen 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":83B4
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":83DC
      ...
      Begin PhotoDemon.jcbutton cmdSave 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":982E
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":9856
         disabledpicturemode=   1
         captioneffects  =   0
         tooltiptitle    =   "Save"
      End
      Begin PhotoDemon.jcbutton cmdUndo 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":A8A8
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":A8D0
         disabledpicturemode=   1
         captioneffects  =   0
         tooltiptitle    =   "Undo"
      ...
      Begin PhotoDemon.jcbutton cmdRedo 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":B922
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":B94A
         disabledpicturemode=   1
         captioneffects  =   0
         tooltiptitle    =   "Redo"
         tooltipbackcolor=   -2147483643
      ...
      Begin PhotoDemon.jcbutton cmdClose 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":C99C
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":C9C4
         disabledpicturemode=   1
         captioneffects  =   0
         tooltiptitle    =   "Close"
      End
      Begin PhotoDemon.jcbutton cmdSaveAs 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":DA16
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":DA3E
         disabledpicturemode=   1
         captioneffects  =   0
      ...
      Begin PhotoDemon.jcbutton cmdZoomIn 
         ...
         _extenty        =   794
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":EA90
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":EAB8
         disabledpicturemode=   1
         captioneffects  =   0
      ...
      Begin PhotoDemon.jcbutton cmdZoomOut 
         ...
         _extenty        =   794
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":EF0A
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":EF32
         disabledpicturemode=   1
         captioneffects  =   0
