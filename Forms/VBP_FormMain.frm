...
Begin VB.MDIForm FormMain 
   ...
   Begin VB.PictureBox picLeftPane 
      ...
      Begin PhotoDemon.jcbutton cmdSave 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":930F
         DisabledPictureMode=   1
         CaptionEffects  =   0
         TooltipTitle    =   "Save"
      End
      Begin PhotoDemon.jcbutton cmdUndo 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":A361
         DisabledPictureMode=   1
         CaptionEffects  =   0
         TooltipTitle    =   "Undo"
      ...
      Begin PhotoDemon.jcbutton cmdRedo 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":B3B3
         DisabledPictureMode=   1
         CaptionEffects  =   0
         TooltipTitle    =   "Redo"
         TooltipBackColor=   -2147483643
      ...
      Begin PhotoDemon.jcbutton cmdSaveAs 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":D457
         DisabledPictureMode=   1
         CaptionEffects  =   0
      ...
      Begin PhotoDemon.jcbutton cmdZoomIn 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":E4A9
         DisabledPictureMode=   1
         CaptionEffects  =   0
      ...
      Begin PhotoDemon.jcbutton cmdZoomOut 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":E8FB
         DisabledPictureMode=   1
         CaptionEffects  =   0
