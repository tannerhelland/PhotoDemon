...
Begin VB.MDIForm FormMain 
   ...
   Begin VB.PictureBox picLeftPane 
      ...
      Begin VB.ComboBox CmbZoom 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "VBP_FormMain.frx":00B7
         Left            =   60
         List            =   "VBP_FormMain.frx":00B9
         Style           =   2  'Dropdown List
         TabIndex        =   5
      ...
      Begin PhotoDemon.jcbutton cmdOpen 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":00BB
      ...
      Begin PhotoDemon.jcbutton cmdSave 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":150D
         DisabledPictureMode=   1
         CaptionEffects  =   0
         TooltipTitle    =   "Save"
      End
      Begin PhotoDemon.jcbutton cmdUndo 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":255F
         DisabledPictureMode=   1
         CaptionEffects  =   0
         TooltipTitle    =   "Undo"
      ...
      Begin PhotoDemon.jcbutton cmdRedo 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":35B1
         DisabledPictureMode=   1
         CaptionEffects  =   0
         TooltipTitle    =   "Redo"
         TooltipBackColor=   -2147483643
      ...
      Begin PhotoDemon.jcbutton cmdClose 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":4603
         DisabledPictureMode=   1
         CaptionEffects  =   0
         TooltipTitle    =   "Close"
      End
      Begin PhotoDemon.jcbutton cmdSaveAs 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":5655
         DisabledPictureMode=   1
         CaptionEffects  =   0
      ...
      Begin PhotoDemon.jcbutton cmdZoomIn 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":66A7
         DisabledPictureMode=   1
         CaptionEffects  =   0
      ...
      Begin PhotoDemon.jcbutton cmdZoomOut 
         ...
         Caption         =   ""
         HandPointer     =   -1  'True
         PictureNormal   =   "VBP_FormMain.frx":6AF9
         DisabledPictureMode=   1
         CaptionEffects  =   0
