...
Begin VB.MDIForm FormMain 
   ...
   Begin VB.PictureBox picLeftPane 
      ...
      Begin VB.ComboBox CmbZoom 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "VBP_FormMain.frx":82B9
         Left            =   60
         List            =   "VBP_FormMain.frx":82BB
         Style           =   2  'Dropdown List
         TabIndex        =   5
      ...
      Begin PhotoDemon.jcbutton cmdOpen 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":82BD
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":82E5
      ...
      Begin PhotoDemon.jcbutton cmdSave 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":9337
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":935F
         disabledpicturemode=   1
         captioneffects  =   0
         tooltiptitle    =   "Save"
      End
      Begin PhotoDemon.jcbutton cmdUndo 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":A3B1
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":A3D9
         disabledpicturemode=   1
         captioneffects  =   0
         tooltiptitle    =   "Undo"
      ...
      Begin PhotoDemon.jcbutton cmdRedo 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":B42B
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":B453
         disabledpicturemode=   1
         captioneffects  =   0
         tooltiptitle    =   "Redo"
         tooltipbackcolor=   -2147483643
      ...
      Begin PhotoDemon.jcbutton cmdClose 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":C4A5
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":C4CD
         disabledpicturemode=   1
         captioneffects  =   0
         tooltiptitle    =   "Close"
      End
      Begin PhotoDemon.jcbutton cmdSaveAs 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":D51F
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":D547
         disabledpicturemode=   1
         captioneffects  =   0
      ...
      Begin PhotoDemon.jcbutton cmdZoomIn 
         ...
         _extenty        =   794
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":E599
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":E5C1
         disabledpicturemode=   1
         captioneffects  =   0
      ...
      Begin PhotoDemon.jcbutton cmdZoomOut 
         ...
         _extenty        =   794
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":EA13
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_FormMain.frx":EA3B
         disabledpicturemode=   1
         captioneffects  =   0
