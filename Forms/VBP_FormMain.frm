...
Begin VB.MDIForm FormMain 
   ...
   Begin VB.PictureBox picLeftPane 
      ...
      Begin VB.ComboBox CmbZoom 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "VBP_FormMain.frx":8311
         Left            =   60
         List            =   "VBP_FormMain.frx":8313
         Style           =   2  'Dropdown List
         TabIndex        =   5
      ...
      Begin PhotoDemon.jcbutton cmdOpen 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":8315
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1
         picturenormal   =   "VBP_FormMain.frx":833D
      ...
      Begin PhotoDemon.jcbutton cmdSave 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":978F
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1
         picturenormal   =   "VBP_FormMain.frx":97B7
         disabledpicturemode=   1
         captioneffects  =   0
         tooltiptitle    =   "Save"
      End
      Begin PhotoDemon.jcbutton cmdUndo 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":A809
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1
         picturenormal   =   "VBP_FormMain.frx":A831
         disabledpicturemode=   1
         captioneffects  =   0
         tooltiptitle    =   "Undo"
      ...
      Begin PhotoDemon.jcbutton cmdRedo 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":B883
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1
         picturenormal   =   "VBP_FormMain.frx":B8AB
         disabledpicturemode=   1
         captioneffects  =   0
         tooltiptitle    =   "Redo"
         tooltipbackcolor=   -2147483643
      ...
      Begin PhotoDemon.jcbutton cmdClose 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":C8FD
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1
         picturenormal   =   "VBP_FormMain.frx":C925
         disabledpicturemode=   1
         captioneffects  =   0
         tooltiptitle    =   "Close"
      End
      Begin PhotoDemon.jcbutton cmdSaveAs 
         ...
         _extenty        =   1085
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":D977
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1
         picturenormal   =   "VBP_FormMain.frx":D99F
         disabledpicturemode=   1
         captioneffects  =   0
      ...
      Begin PhotoDemon.jcbutton cmdZoomIn 
         ...
         _extenty        =   794
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":E9F1
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1
         picturenormal   =   "VBP_FormMain.frx":EA19
         disabledpicturemode=   1
         captioneffects  =   0
      ...
      Begin PhotoDemon.jcbutton cmdZoomOut 
         ...
         _extenty        =   794
         buttonstyle     =   13
         font            =   "VBP_FormMain.frx":EE6B
         backcolor       =   15199212
         caption         =   ""
         handpointer     =   -1
         picturenormal   =   "VBP_FormMain.frx":EE93
         disabledpicturemode=   1
         captioneffects  =   0
