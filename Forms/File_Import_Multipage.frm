...
'Copyright 2011-2018 by Tanner Helland
...
Private Sub cmdAnswer_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 0
            userAnswer = vbYes
            If CBool(chkRepeat.Value) Then UserPrefs.SetPref_Long "Loading", "Multipage Image Prompt", 2
            
        Case 1
            userAnswer = vbNo
            If CBool(chkRepeat.Value) Then UserPrefs.SetPref_Long "Loading", "Multipage Image Prompt", 1
