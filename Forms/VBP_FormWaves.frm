...
Private Sub updatePreview()
    If cmdBar.previewsAllowed Then WaveImage sltWavelengthX, sltAmplitudeX, sltWavelengthY, sltAmplitudeY, CLng(cmbEdges.ListIndex), OptInterpolate(0).Value, True, fxPreview
End Sub
