...
'Last update: simplified code by utilizing new slider/text custom control
'
...
Private Sub updatePreview()
    SwirlImage sltAngle, sltRadius, CLng(cmbEdges.ListIndex), OptInterpolate(0).Value, True, fxPreview
End Sub
