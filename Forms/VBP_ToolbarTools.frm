...
Begin VB.Form toolbar_Tools 
   ...
   Begin VB.PictureBox picTools 
      ...
      Begin PhotoDemon.jcbutton cmdQuickFix 
         ...
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_ToolbarTools.frx":60E2
         pictureeffectondown=   0
         captioneffects  =   0
         colorscheme     =   3
      End
      Begin PhotoDemon.jcbutton cmdQuickFix 
         ...
         _extenty        =   1005
         buttonstyle     =   13
         font            =   "VBP_ToolbarTools.frx":6E34
         backcolor       =   -2147483643
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_ToolbarTools.frx":6E5C
         pictureeffectondown=   0
         captioneffects  =   0
         colorscheme     =   3
      End
      Begin PhotoDemon.sliderTextCombo sltQuickFix 
         ...
         _extentx        =   4710
         _extenty        =   873
         font            =   "VBP_ToolbarTools.frx":7BAE
         min             =   -100
         max             =   100
         slidertrackstyle=   3
      ...
      Begin PhotoDemon.sliderTextCombo sltQuickFix 
         ...
         _extentx        =   4710
         _extenty        =   873
         font            =   "VBP_ToolbarTools.frx":7BD6
         min             =   -100
         max             =   100
         slidertrackstyle=   3
   ...
   Begin VB.PictureBox picTools 
      ...
      Begin PhotoDemon.smartCheckBox chkLayerBorder 
         ...
         font            =   "VBP_ToolbarTools.frx":7BFE
      End
   ...
   Begin PhotoDemon.jcbutton cmdTools 
      ...
      mode            =   1
      handpointer     =   -1  'True
      picturenormal   =   "VBP_ToolbarTools.frx":7CC6
      pictureeffectondown=   0
      captioneffects  =   0
      colorscheme     =   3
   End
...
Public Sub resetToolButtonStates()
    ...
    Select Case g_CurrentTool
        ...
        Case SELECT_POLYGON
            ...
            lblSelection(5).Caption = g_Language.TranslateMessage("edge curvature")
