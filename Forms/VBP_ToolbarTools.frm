...
Begin VB.Form toolbar_Tools 
   ...
   Begin VB.PictureBox picTools 
      ...
      Begin VB.Label lblOptions 
         ...
         Caption         =   "quick fix options forthcoming..."
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox picTools 
      ...
      Begin VB.ComboBox cmbSelRender 
         ...
         Height          =   360
         Index           =   0
         ItemData        =   "VBP_ToolbarTools.frx":4BBC
         Left            =   120
         List            =   "VBP_ToolbarTools.frx":4BBE
      ...
      Begin VB.ComboBox cmbSelType 
         ...
         Height          =   360
         Index           =   0
         ItemData        =   "VBP_ToolbarTools.frx":4BC0
         Left            =   8340
         List            =   "VBP_ToolbarTools.frx":4BC2
         Style           =   2  'Dropdown List
         TabIndex        =   2
         TabStop         =   0   'False
      ...
      Begin VB.ComboBox cmbSelSmoothing 
         ...
         Height          =   360
         Index           =   0
         ItemData        =   "VBP_ToolbarTools.frx":4BC4
         Left            =   5640
         List            =   "VBP_ToolbarTools.frx":4BC6
         Style           =   2  'Dropdown List
         TabIndex        =   1
         TabStop         =   0   'False
      ...
      Begin PhotoDemon.sliderTextCombo sltCornerRounding 
         ...
         _extentx        =   4710
         _extenty        =   873
         font            =   "VBP_ToolbarTools.frx":4BC8
         max             =   10000
      End
      Begin PhotoDemon.textUpDown tudSel 
         ...
         _extentx        =   2328
         _extenty        =   714
         font            =   "VBP_ToolbarTools.frx":4BF0
         min             =   -30000
         max             =   30000
      End
      Begin PhotoDemon.textUpDown tudSel 
         ...
         _extentx        =   2328
         _extenty        =   714
         font            =   "VBP_ToolbarTools.frx":4C18
         min             =   -30000
         max             =   30000
      End
      Begin PhotoDemon.textUpDown tudSel 
         ...
         _extentx        =   2328
         _extenty        =   714
         font            =   "VBP_ToolbarTools.frx":4C40
         min             =   -30000
         max             =   30000
      End
      Begin PhotoDemon.textUpDown tudSel 
         ...
         _extentx        =   2328
         _extenty        =   714
         font            =   "VBP_ToolbarTools.frx":4C68
         min             =   -30000
         max             =   30000
      End
      Begin PhotoDemon.sliderTextCombo sltSelectionBorder 
         ...
         _extentx        =   4710
         _extenty        =   873
         font            =   "VBP_ToolbarTools.frx":4C90
         min             =   1
         max             =   10000
         value           =   1
      End
      Begin PhotoDemon.sliderTextCombo sltSelectionFeathering 
         ...
         _extentx        =   4710
         _extenty        =   873
         font            =   "VBP_ToolbarTools.frx":4CB8
         max             =   100
      End
      Begin PhotoDemon.sliderTextCombo sltSelectionLineWidth 
         ...
         _extentx        =   4710
         _extenty        =   873
         font            =   "VBP_ToolbarTools.frx":4CE0
         min             =   1
         max             =   10000
         value           =   10
      End
