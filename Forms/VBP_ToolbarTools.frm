...
Begin VB.Form toolbar_Tools 
   ...
   Begin VB.PictureBox picTools 
      ...
      Begin PhotoDemon.jcbutton cmdQuickFix 
         ...
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_ToolbarTools.frx":6092
         pictureeffectondown=   0
         captioneffects  =   0
         colorscheme     =   3
      End
      Begin PhotoDemon.jcbutton cmdQuickFix 
         ...
         _extenty        =   1005
         buttonstyle     =   13
         font            =   "VBP_ToolbarTools.frx":6DE4
         backcolor       =   -2147483643
         caption         =   ""
         handpointer     =   -1  'True
         picturenormal   =   "VBP_ToolbarTools.frx":6E0C
         pictureeffectondown=   0
         captioneffects  =   0
         colorscheme     =   3
      End
      Begin PhotoDemon.sliderTextCombo sltQuickFix 
         ...
         _extentx        =   4710
         _extenty        =   873
         font            =   "VBP_ToolbarTools.frx":7B5E
         min             =   -100
         max             =   100
         slidertrackstyle=   3
      ...
      Begin PhotoDemon.sliderTextCombo sltQuickFix 
         ...
         _extentx        =   4710
         _extenty        =   873
         font            =   "VBP_ToolbarTools.frx":7B86
         min             =   -100
         max             =   100
         slidertrackstyle=   3
