...
Public Sub UpdateAgainstCurrentTheme()
    ...
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Normal)), "blend_mode_norm"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Darken)), "blend_mode_dark"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Multiply)), "blend_mode_mult"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_ColorBurn)), "blend_mode_cbrn"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_LinearBurn)), "blend_mode_lbrn"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Lighten)), "blend_mode_lght"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Screen)), "blend_mode_scrn"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_ColorDodge)), "blend_mode_cddg"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_LinearDodge)), "blend_mode_lddg"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Overlay)), "blend_mode_ovrl"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_SoftLight)), "blend_mode_sftl"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_HardLight)), "blend_mode_hrdl"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_VividLight)), "blend_mode_vvdl"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_LinearLight)), "blend_mode_lnrl"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_PinLight)), "blend_mode_pinl"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_HardMix)), "blend_mode_hrdm"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Difference)), "blend_mode_diff"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Exclusion)), "blend_mode_excl"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Subtract)), "blend_mode_subt"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Divide)), "blend_mode_divd"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Hue)), "blend_mode_hue"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Saturation)), "blend_mode_satr"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Color)), "blend_mode_clr"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Luminosity)), "blend_mode_lumn"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_GrainExtract)), "blend_mode_gext"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_GrainMerge)), "blend_mode_gmrg"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Erase)), "blend_mode_eras"
    AddToolboxAction g_Language.TranslateMessage("Blend mode: %1", Colors.GetBlendModeFriendlyNameFromID(BM_Behind)), "blend_mode_bhnd"
