...
Public Sub showDialog()
    ...
    If (pdImages(g_CurrentImage).mainLayer.getLayerColorDepth = 24) And (optColorDepth(3).Enabled) Then
        optColorDepth(3).Value = True
    ElseIf (pdImages(g_CurrentImage).mainLayer.getLayerColorDepth = 32) And (optColorDepth(4).Enabled) Then
