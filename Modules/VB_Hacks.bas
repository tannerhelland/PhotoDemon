...
'When an edit box needs to hook the keyboard, it notifies us via this function.  This function returns the
...
' our reference if it hasn't already been stolen by another edit box.
...
'Hooked keyboard events happen here; we simply relay the results to last-referenced pdEditBox
