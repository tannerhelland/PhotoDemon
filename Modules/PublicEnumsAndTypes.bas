...
#If False Then
    ...
    Private Const id_pdfium = 0, id_libheif = 0, id_PCXParser = 0, id_DirectXTex = 0, id_OpenJPEG = 0, id_FITSParser = 0
#End If
...
Public Enum PD_IMAGE_FORMAT
    ...
    PDIF_FITS = 126     'FITS was added in 2025.11
...
#If False Then
    ...
    Const PDIF_PDF = 125, PDIF_FITS = 126, PDIF_MAX_ID = 126
#End If
