...
Public Function LoadFileToDIB(ByRef dstDIB As pdDIB, ByRef srcFile As String) As Boolean
    ...
    If (IWICImagingFactory_CreateDecoderFromFilename_Proxy(m_WICImagingFactory, StrPtr(srcFile), UUID_NULL, GENERIC_READ, WICDecodeMetadataCacheOnDemand, iWICBitmapDecoder) <> S_OK) Then Exit Function
...
Private Function UUID_NULL() As GUID
